...
50,000円〜100,000円`,
    ...
    budgetType: 'fixed',
    budget: 80000,
    deadline: Timestamp.fromDate(new Date('2025-01-15')),
    status: 'open',
...
30,000円（税込）`,
    ...
    budgetType: 'fixed',
    budget: 30000,
    deadline: Timestamp.fromDate(new Date('2025-01-10')),
    status: 'open',
    competition: {
      guaranteed: true,
      additionalPrizes: []
...
- 不正回答は非承認となります`,
    ...
    budgetType: 'fixed',
    budget: 10000,
    deadline: Timestamp.fromDate(new Date('2025-01-20')),
    status: 'open',
    task: {
      unitPrice: 100,
      quantity: 100,
...
150,000円〜200,000円`,
    ...
    budgetType: 'fixed',
    budget: 180000,
    deadline: Timestamp.fromDate(new Date('2025-02-01')),
    status: 'open',
    createdAt: Timestamp.now(),
    updatedAt: Timestamp.now(),
    proposalCount: 0
...
10,000円`,
    ...
    budgetType: 'fixed',
    budget: 10000,
    deadline: Timestamp.fromDate(new Date('2025-01-08')),
    status: 'open',
    competition: {
      guaranteed: true,
      additionalPrizes: []
...
async function restoreJobs() {
  console.log('Firestore jobsコレクションの復元を開始します...');
  ...
  for (const job of sampleJobs) {
    try {
      ...
      console.error(`❌ エラー: ${job.title}`, error);
    }
  }
