        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-8 text-text-body">
                ...
                <section>
                    ...
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                        <li><strong>「本サービス」</strong>: 運営者が運営する「Project Market Hub」と称するウェブサイトおよび関連サービス。</li>
                        ...
                        <li><strong>「本取引」</strong>: 本サービスを通じてクライアントとワーカーの間で締結される業務委託契約。</li>
                        <li><strong>「仮払い」</strong>: クライアントがワーカーに対する報酬を、運営者が指定する決済サービスを通じて一時的に預け入れること。</li>
                    </ol>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第3条 (利用登録)</h2>
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                ...
                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第4条 (ユーザーIDおよびパスワードの管理)</h2>
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                ...
                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第5条 (禁止事項)</h2>
                    ...
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                        ...
                        <li>本サービス外での直接取引を誘引する行為（直接取引の禁止）</li>
                ...
                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第6条 (本サービスの提供の停止等)</h2>
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                ...
                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第7条 (利用制限および登録抹消)</h2>
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                ...
                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第8条 (退会)</h2>
                    <p>ユーザーは、運営者の定める退会手続により、本サービスから退会できるものとします。ただし、未完了の取引（仮払い中の案件、検収待ちの案件等）がある場合は、それらが完了するまで退会できません。</p>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第9条 (保証の否認および免責事項)</h2>
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                ...
                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第10条 (サービス内容の変更等)</h2>
                    <p>運営者は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第11条 (利用規約の変更)</h2>
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                ...
                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第12条 (個人情報の取扱い)</h2>
                    <p>運営者は、本サービスの利用によって取得する個人情報については、別途定める「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第13条 (通知または連絡)</h2>
                ...
                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第14条 (権利義務の譲渡の禁止)</h2>
                    <p>ユーザーは、運営者の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</p>
                </section>

                <section>
                    <h2 className="text-xl font-bold mb-4 text-secondary border-b pb-2">第15条 (準拠法・裁判管轄)</h2>
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                        <li>本規約の解釈にあたっては、日本法を準拠法とします。</li>
                        <li>本サービスに関して紛争が生じた場合には、運営者の所在地を管轄する裁判所を専属的合意管轄裁判所とします。</li>
                    </ol>
                </section>
