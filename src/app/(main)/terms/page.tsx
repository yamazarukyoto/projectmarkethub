            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-8 text-text-body">
                ...
                <section>
                    ...
                    <ol className="list-decimal list-inside space-y-2 ml-2">
                        ...
                        <li><strong>入金手数料：</strong>ワーカーがStripeアカウントから銀行口座へ入金する際の手数料（入金額の0.25% + 250円）は、<strong>ワーカーの負担</strong>とします。</li>
                        <li><strong>入金スケジュール：</strong>ワーカーへの銀行口座への入金は、<strong>毎月25日</strong>に行われます。</li>
                    </ol>
                </section>
