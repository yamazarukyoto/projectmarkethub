    ...
    for (const doc of snapshot.docs) {
        ...
        try {
            ...
            if (worker && worker.email && ((_a = worker.notificationSettings) === null || _a === void 0 ? void 0 : _a.emailContract) !== false) {
                await sendEmail(worker.email, "縲娠roject Market Hub縲題・蜍墓､懷庶縺ｮ縺顔衍繧峨○", `${contract.jobTitle} 縺ｮ讀懷庶縺瑚・蜍慕噪縺ｫ螳御ｺ・＠縺ｾ縺励◆縲ょｱ驟ｬ縺梧髪謇輔ｏ繧後∪縺吶Ａ);
            }
        }
        catch (error) {
...
exports.sendUnreadMessageNotifications = functions.pubsub.schedule("every 15 minutes").onRun(async (context) => {
    ...
    for (const [userId, msgs] of userMessages) {
        ...
        if (user && user.email && ((_b = user.notificationSettings) === null || _b === void 0 ? void 0 : _b.emailMessage) !== false) {
            await sendEmail(user.email, "縲娠roject Market Hub縲第眠逹繝｡繝・そ繝ｼ繧ｸ縺後≠繧翫∪縺・, `縺ゅ↑縺溘・ ${msgs.length} 莉ｶ縺ｮ譛ｪ隱ｭ繝｡繝・そ繝ｼ繧ｸ繧貞女縺大叙縺｣縺ｦ縺・∪縺吶・n\n繧ｵ繧､繝医↓繝ｭ繧ｰ繧､繝ｳ縺励※遒ｺ隱阪＠縺ｦ縺上□縺輔＞縲・nhttps://pj-markethub.com/messages`);
        }
    }
    // Mark as sent
    const batch = db.batch();
...
exports.onContractUpdate = functions.firestore
    ...
    if (newData.status === "waiting_for_escrow") {
        if (client && client.email && ((_a = client.notificationSettings) === null || _a === void 0 ? void 0 : _a.emailContract) !== false) {
            await sendEmail(client.email, "縲娠roject Market Hub縲大･醍ｴ・′蜷域э縺輔ｌ縺ｾ縺励◆", `${(worker === null || worker === void 0 ? void 0 : worker.displayName) || "繝ｯ繝ｼ繧ｫ繝ｼ"} 縺梧｡井ｻｶ縲・{newData.jobTitle}縲阪・螂醍ｴ・↓蜷域э縺励∪縺励◆縲・n莉ｮ豎ｺ貂医ｒ陦後▲縺ｦ縺上□縺輔＞縲・n\nhttps://pj-markethub.com/client/contracts/${contractId}`);
        }
    }
    ...
    if (newData.status === "escrow") {
        if (worker && worker.email && ((_b = worker.notificationSettings) === null || _b === void 0 ? void 0 : _b.emailContract) !== false) {
            await sendEmail(worker.email, "縲娠roject Market Hub縲台ｻｮ豎ｺ貂医′螳御ｺ・＠縺ｾ縺励◆", `譯井ｻｶ縲・{newData.jobTitle}縲阪・莉ｮ豎ｺ貂医′螳御ｺ・＠縺ｾ縺励◆縲・n讌ｭ蜍吶ｒ髢句ｧ九＠縺ｦ縺上□縺輔＞縲・n\nhttps://pj-markethub.com/worker/contracts/${contractId}`);
        }
    }
    ...
    if (newData.status === "submitted") {
        if (client && client.email && ((_c = client.notificationSettings) === null || _c === void 0 ? void 0 : _c.emailContract) !== false) {
            await sendEmail(client.email, "縲娠roject Market Hub縲醍ｴ榊刀蝣ｱ蜻翫′縺ゅｊ縺ｾ縺励◆", `${(worker === null || worker === void 0 ? void 0 : worker.displayName) || "繝ｯ繝ｼ繧ｫ繝ｼ"} 縺九ｉ譯井ｻｶ縲・{newData.jobTitle}縲阪・邏榊刀蝣ｱ蜻翫′縺ゅｊ縺ｾ縺励◆縲・n蜀・ｮｹ繧堤｢ｺ隱阪＠縲∵､懷庶繧定｡後▲縺ｦ縺上□縺輔＞縲・n\nhttps://pj-markethub.com/client/contracts/${contractId}`);
        }
    }
    ...
    if (newData.status === "completed") {
        if (worker && worker.email && ((_d = worker.notificationSettings) === null || _d === void 0 ? void 0 : _d.emailContract) !== false) {
            await sendEmail(worker.email, "縲娠roject Market Hub縲第､懷庶縺悟ｮ御ｺ・＠縺ｾ縺励◆", `譯井ｻｶ縲・{newData.jobTitle}縲阪・讀懷庶縺悟ｮ御ｺ・＠縺ｾ縺励◆縲・n蝣ｱ驟ｬ縺梧髪謇輔ｏ繧後∪縺吶・n\nhttps://pj-markethub.com/worker/contracts/${contractId}`);
        }
    }
    return null;
});
exports.onContractCreate = functions.firestore
    ...
    if (data.status === "pending_signature") {
        ...
        if (worker && worker.email && ((_a = worker.notificationSettings) === null || _a === void 0 ? void 0 : _a.emailContract) !== false) {
            await sendEmail(worker.email, "縲娠roject Market Hub縲大･醍ｴ・が繝輔ぃ繝ｼ縺悟ｱ翫″縺ｾ縺励◆", `${(client === null || client === void 0 ? void 0 : client.displayName) || "繧ｯ繝ｩ繧､繧｢繝ｳ繝・} 縺九ｉ譯井ｻｶ縲・{data.jobTitle}縲阪・螂醍ｴ・が繝輔ぃ繝ｼ縺悟ｱ翫″縺ｾ縺励◆縲・n蜀・ｮｹ繧堤｢ｺ隱阪＠縲∝粋諢上＠縺ｦ縺上□縺輔＞縲・n\nhttps://pj-markethub.com/worker/contracts/${context.params.contractId}`);
        }
    }
    return null;
});
...
exports.notifyUpcomingDeletion = functions.pubsub.schedule("every 24 hours").onRun(async (context) => {
    ...
    for (const doc of twoWeeksSnapshot.docs) {
        ...
        if (client && client.email) {
            await sendEmail(client.email, "縲娠roject Market Hub縲大･醍ｴ・ョ繝ｼ繧ｿ蜑企勁縺ｮ縺顔衍繧峨○・・騾ｱ髢灘燕・・, `譯井ｻｶ縲・{contract.jobTitle}縲阪・螂醍ｴ・ョ繝ｼ繧ｿ縺ｯ縲∝ｮ御ｺ・°繧・縺区怦蠕後↓閾ｪ蜍募炎髯､縺輔ｌ縺ｾ縺吶・n\n蜑企勁莠亥ｮ壽律: 邏・騾ｱ髢灘ｾ圭n\n蠢・ｦ√↑繝・・繧ｿ・育ｴ榊刀迚ｩ縲√Γ繝・そ繝ｼ繧ｸ遲会ｼ峨・縲∝炎髯､蜑阪↓繝繧ｦ繝ｳ繝ｭ繝ｼ繝峨＠縺ｦ菫晏ｭ倥＠縺ｦ縺上□縺輔＞縲・n\nhttps://pj-markethub.com/client/contracts/${doc.id}`);
        }
        // 繝ｯ繝ｼ繧ｫ繝ｼ縺ｫ騾夂衍
        if (worker && worker.email) {
            await sendEmail(worker.email, "縲娠roject Market Hub縲大･醍ｴ・ョ繝ｼ繧ｿ蜑企勁縺ｮ縺顔衍繧峨○・・騾ｱ髢灘燕・・, `譯井ｻｶ縲・{contract.jobTitle}縲阪・螂醍ｴ・ョ繝ｼ繧ｿ縺ｯ縲∝ｮ御ｺ・°繧・縺区怦蠕後↓閾ｪ蜍募炎髯､縺輔ｌ縺ｾ縺吶・n\n蜑企勁莠亥ｮ壽律: 邏・騾ｱ髢灘ｾ圭n\n蠢・ｦ√↑繝・・繧ｿ・育ｴ榊刀迚ｩ縲√Γ繝・そ繝ｼ繧ｸ遲会ｼ峨・縲∝炎髯､蜑阪↓繝繧ｦ繝ｳ繝ｭ繝ｼ繝峨＠縺ｦ菫晏ｭ倥＠縺ｦ縺上□縺輔＞縲・n\nhttps://pj-markethub.com/worker/contracts/${doc.id}`);
        }
        // 騾夂衍貂医∩繝輔Λ繧ｰ繧定ｨｭ螳・
    ...
    for (const doc of oneWeekSnapshot.docs) {
        ...
        // 繧ｯ繝ｩ繧､繧｢繝ｳ繝医↓騾夂衍
        if (client && client.email) {
            await sendEmail(client.email, "縲娠roject Market Hub縲大･醍ｴ・ョ繝ｼ繧ｿ蜑企勁縺ｮ縺顔衍繧峨○・・騾ｱ髢灘燕・・, `縲宣㍾隕√第｡井ｻｶ縲・{contract.jobTitle}縲阪・螂醍ｴ・ョ繝ｼ繧ｿ縺ｯ縲√∪繧ゅ↑縺剰・蜍募炎髯､縺輔ｌ縺ｾ縺吶・n\n蜑企勁莠亥ｮ壽律: 邏・騾ｱ髢灘ｾ圭n\n蠢・ｦ√↑繝・・繧ｿ・育ｴ榊刀迚ｩ縲√Γ繝・そ繝ｼ繧ｸ遲会ｼ峨・縲∽ｻ翫☆縺舌ム繧ｦ繝ｳ繝ｭ繝ｼ繝峨＠縺ｦ菫晏ｭ倥＠縺ｦ縺上□縺輔＞縲・n\nhttps://pj-markethub.com/client/contracts/${doc.id}`);
        }
        // 繝ｯ繝ｼ繧ｫ繝ｼ縺ｫ騾夂衍
        if (worker && worker.email) {
            await sendEmail(worker.email, "縲娠roject Market Hub縲大･醍ｴ・ョ繝ｼ繧ｿ蜑企勁縺ｮ縺顔衍繧峨○・・騾ｱ髢灘燕・・, `縲宣㍾隕√第｡井ｻｶ縲・{contract.jobTitle}縲阪・螂醍ｴ・ョ繝ｼ繧ｿ縺ｯ縲√∪繧ゅ↑縺剰・蜍募炎髯､縺輔ｌ縺ｾ縺吶・n\n蜑企勁莠亥ｮ壽律: 邏・騾ｱ髢灘ｾ圭n\n蠢・ｦ√↑繝・・繧ｿ・育ｴ榊刀迚ｩ縲√Γ繝・そ繝ｼ繧ｸ遲会ｼ峨・縲∽ｻ翫☆縺舌ム繧ｦ繝ｳ繝ｭ繝ｼ繝峨＠縺ｦ菫晏ｭ倥＠縺ｦ縺上□縺輔＞縲・n\nhttps://pj-markethub.com/worker/contracts/${doc.id}`);
        }
        // 騾夂衍貂医∩繝輔Λ繧ｰ繧定ｨｭ螳・
